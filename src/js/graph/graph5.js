$(function(){
    function pageLoad(){
        ...
        function drawSparkLines(){
            ...
            options.lineColor = $pink;
            options.fillColor = 'rgba(218,112,214, 0.1)';
            $('#a-trend').sparkline(values[5],options);
        }
    ...
    $('.dd-handle,.trans-name,.trace-name').click(function () {
